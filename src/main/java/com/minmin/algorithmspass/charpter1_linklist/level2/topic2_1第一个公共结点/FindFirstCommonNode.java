package com.minmin.algorithmspass.charpter1_linklist.level2.topic2_1第一个公共结点;
...
//        ListNode lb = heads[1];
        ...
        switch (testMethod) {
            ...
            case 2: //方法2：通过集合辅助查找
                ...
                break;
            case 3://方法3：通过栈辅助查找
                node = findFirstCommonNodeByStack2(la, lb);
                break;
            case 4://方法4：通过拼接辅助查找
     ...
     * @return
     */
    public static ListNode findFirstCommonNodeByStack2(ListNode headA, ListNode headB) {
    ...
    /**
     * 方法3：通过栈，原理是压栈是先进后出，同时两个链表交叉后的那一部分节点是相同个数的，
     * 都在栈的上半部分，这样只需要一起弹出直到找到栈顶相等的那个节点就OK了
     */
