package com.minmin.algorithmspass.charpter16_slide.level1;
...
public class FindLengthOfLCIS {
    ...
    /**
     * 滑动窗口要搞清楚左边界和右边界为什么要移动，什么情况下会移动
     * 固定窗口和非固定窗口都是统一的思想，这是关键点
     * @param nums
     * @return
     */
    public static int findLengthOfLCIS_1ByMyself(int[] nums) {
        int left = 0, right = 0;
        int res = 0;
