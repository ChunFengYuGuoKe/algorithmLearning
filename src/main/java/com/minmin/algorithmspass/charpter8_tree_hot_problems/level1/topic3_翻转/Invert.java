package com.minmin.algorithmspass.charpter8_tree_hot_problems.level1.topic3_翻转;
...
//        bTree.root = bTree.buildBinaryTree();
    ...
    public static TreeNode invertTree_1ByMyself(TreeNode root) {
        if (root == null) return null;
        TreeNode temp = root.left;
        root.left = root.right;
        root.right = temp;
        invertTree_1ByMyself(root.left);
        invertTree_1ByMyself(root.right);
        return root;
     ...
     * @return
     */
    public static TreeNode invertTree_3ByMyself(TreeNode root) {
        if (root == null) return null;
